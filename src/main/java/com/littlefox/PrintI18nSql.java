...
public class PrintI18nSql {
        ...
        for(int i=0;i<cn_childList.getLength();i++){
            ...
            for (int j = 0; j < en_childList.getLength(); j++) {
                ...
                if (cn_ele.getAttribute("Code").equals(en_ele.getAttribute("Code"))){
                    ...
                    int count=++country;
                    System.out.println("insert into sys_lang(e_lang_type,vc_name,vc_code) values ('zh_CN',\""+cn_ele.getAttribute("Name")+"\",'COUNTRY."+count+"');");
                    System.out.println("insert into sys_lang(e_lang_type,vc_name,vc_code) values ('en_US',\""+en_ele.getAttribute("Name")+"\",'COUNTRY."+count+"');");

                    int sum=1*(i+1)+100;
                    System.out.println("1、('"+sum+"','COUNTRY."+count+"','0');");
            ...
            for (int i = 0; i < en_state.getLength(); i++) {
                ...
                if (cn_state_ele.getAttribute("Code").equals(en_state_ele.getAttribute("Code"))){
                    if (cn_state_ele.hasAttribute("Code")){
                        int count=state++;
                        System.out.println("insert into sys_lang(e_lang_type,vc_name,vc_code) values ('zh_CN',\""+cn_state_ele.getAttribute("Name")+"\",'STATE."+count+"');");
                        System.out.println("insert into sys_lang(e_lang_type,vc_name,vc_code) values ('en_US',\""+en_state_ele.getAttribute("Name")+"\",'STATE."+count+"');");

                        //System.out.println("===2、 ('"+(1*(j+1)+sum*100)+"','STATE."+count+"','1');");
        ...
        for (int k = 0; k < cn_citi.getLength(); k++) {
            ...
            for (int l = 0; l < en_citi.getLength(); l++) {
                ...
                if (cn_citi_ele.getAttribute("Code").equals(en_citi_ele.getAttribute("Code"))){
                    ...
                    if ("y".equals(istype)){
                        System.out.println("insert into sys_lang(e_lang_type,vc_name,vc_code) values ('zh_CN',\""+cn_citi_ele.getAttribute("Name")+"\",'CITY."+count+"');");
                        System.out.println("insert into sys_lang(e_lang_type,vc_name,vc_code) values ('en_US',\""+en_citi_ele.getAttribute("Name")+"\",'CITY."+count+"');");

                        //System.out.println("======3、('"+(1*(k+1)+sum*100)+"','CITY."+count+"','2');");

                        getRegionChild(cn_citi_ele,en_citi_ele,(1*(k+1)+sum*100),"y");
                    }else {
                        System.out.println("insert into sys_lang(e_lang_type,vc_name,vc_code) values ('zh_CN',\""+cn_citi_ele.getAttribute("Name")+"\",'STATE."+count+"');");
                        System.out.println("insert into sys_lang(e_lang_type,vc_name,vc_code) values ('en_US',\""+en_citi_ele.getAttribute("Name")+"\",'STATE."+count+"');");

                        //System.out.println("======3、('"+(1*(k+1)+sum)+"','STATE."+count+"','1');");
    ...
    public static void getRegionChild(Element cn_ele,Element en_ele,int sum,String istype){
        ...
        for (int m = 0; m < cn_region.getLength(); m++) {
            ...
            if ("y".equals(istype)){
                System.out.println("insert into sys_lang(e_lang_type,vc_name,vc_code) values ('zh_CN',\""+cn_region_ele.getAttribute("Name")+"\",'REGION."+count+"');");
                System.out.println("insert into sys_lang(e_lang_type,vc_name,vc_code) values ('en_US',\""+properties.getProperty(cn_region_ele.getAttribute("Name"))+"\",'REGION."+count+"');");
                //System.out.println("=========4、('"+(1*(m+1)+sum*100)+"','REGION."+count+"','3');");
            }else {
